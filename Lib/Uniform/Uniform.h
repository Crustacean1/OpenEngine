...
namespace OpenEngine
{
    ...
    class Uniform
    {
        ...
        static unsigned int __maxUniformsCount;
        static T *__uniforms[];
        ...
        Uniform(Shader * _sh) : shader(_sh),uniformId((__uniformsCount<__maxUniformsCount)*(__uniformsCount++) - (__uniformsCount>__maxUniformsCount)){uniformName = createBasename(__uniformsCount);}
    ...
    {
        if(__maxUniformsCount==1){return __basename;}
