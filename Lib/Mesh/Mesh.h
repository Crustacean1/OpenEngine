...
namespace OpenEngine
{
    ...
    public:
        ...
        static std::shared_ptr<SimpleMesh<Vertex3pcn, V3Index>> generateTorus(unsigned int resolution = 10, float size = 1);
        static std::shared_ptr<SimpleMesh<Vertex3pcn, V3Index>> generateSphere(unsigned int resolution = 10, float size = 1);
