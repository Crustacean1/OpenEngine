...
%.o: %.cpp %.h
	g++ -g -fdiagnostics-show-option -I/home/kamil2/Libraries/glfw-3.3.2/include/ -I/home/kamil2/Libraries/GLAD/ -I/home/kamil2/Libraries/glm -std=c++20 -c $< -o ${subst cpp,o,$<}
