...
class FractalComponent : public OpenEngine::Behaviour
{
    ...
    OpenEngine::Render *render;
    OpenEngine::Shader * shader;

public:
    int counter;
    FractalComponent(OpenEngine::Object &_obj, OpenEngine::BehaviourManager *_bm, OpenEngine::Render *_r,OpenEngine::Shader * _s, unsigned int _count = 5) : 
