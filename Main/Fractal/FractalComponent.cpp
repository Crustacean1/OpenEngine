...
void FractalComponent::init()
{
    ...
    newObject1->addComponent<MeshRenderer>(SimpleMesh<Vertex3pc,V3Index>::generateSphere(6,1),shader)->setManager(render);
    ...
    newObject2->addComponent<MeshRenderer>(SimpleMesh<Vertex3pc,V3Index>::generateSphere(6,1),shader)->setManager(render);
